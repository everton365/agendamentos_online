...
const HeroSection = ({ studio }: HeroSectionProps) => {
  ...
  return (
    <section className="relative w-full max-w-[1350px] mx-auto h-screen overflow-hidden flex items-center justify-center">
      <img
        src={studio?.foto_capa || undefined}
        alt="Capa Desktop"
        ...
        <div className="animate-fade-in">
          <h1 className="font-cinzel font-extrabold text-center relative -mt-10 mb-0 uppercase leading-none">
            <span
              ...
              style={{ fontSize: "clamp(2rem, 10vw, 9rem)", backgroundSize: "100% 100%" }}
              aria-hidden="true"
            >
              {studio?.nome_studio || "Carregando..."}
            </span>
            <span
          ...
          <h2 className="font-cinzel font-extrabold text-center relative mt-2 mb-5 uppercase leading-none">
            <span
              ...
              style={{ fontSize: "clamp(1.2rem, 2.5vw, 2.7rem)", backgroundSize: "100% 100%" }}
            >
              Especialista em
            </span>
            <span
          ...
          <div className="flex justify-center mt-4 mb-4 sm:mb-6">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-elegant p-2 inline-flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-muted-foreground font-poppins">Técnicas Avançadas</div>
              </div>
            </div>
          </div>
        </div>
