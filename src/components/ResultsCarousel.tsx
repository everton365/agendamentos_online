...
const results = [
  {
    ...
    description: "Transformação completa com técnica de microblading para criar fios naturais",
    technique: "Microblading"
  },
  {
    image: beforeAfter2,
    title: "Design Personalizado",
    description: "Modelagem e design personalizado respeitando as características faciais",
    technique: "Design"
  },
  {
    image: beforeAfter3,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl font-bold text-foreground mb-4">
            Resultados <span className="bg-gradient-primary bg-clip-text text-transparent">Impressionantes</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Confira algumas das transformações realizadas em nossa clínica. 
            Cada trabalho é único e personalizado para cada cliente.
          </p>
        </div>
