...
const ResultsCarousel = ({ results }: ResultsCarouselProps) => {
    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20 animate-fade-in">
          <h2 className="text-4xl font-cinzel font-bold text-foreground mb-6" data-aos="fade-right">
            Resultados{" "}
            <span style={{ color: "#D4AF37" }} className="bg-gradient-primary bg-clip-text text-transparent" data-aos="fade-left">
              Impressionantes
            </span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto" data-aos="fade-down">
          <Carousel className="w-full">
            <CarouselContent className="-ml-4">
              {results.map((result) => (
                <CarouselItem key={result.id} className="pl-4 md:basis-1/2 lg:basis-1/2">
