...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      review: {
        Row: {
          created_at: string
          id: number
          review_depoiment: string | null
          review_name: string | null
          review_star: string | null
          studio_id: string | null
        }
        Insert: {
          created_at?: string
    ...
    Functions: {
      call_cancel_pending: { Args: never; Returns: undefined }
    }
    Enums: {
      [_ in never]: never
    }
